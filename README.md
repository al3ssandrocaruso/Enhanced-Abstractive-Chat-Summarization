...
- emoji_m1 : If True it replaces emojis in the dataset with custom token containing their most similar words based on a W2V model which was trained on a twitter dataset.
