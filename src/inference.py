...
if args.train_configuration == "base":
    finetune_model = bart.BartForConditionalGeneration.from_pretrained(args.model_checkpoint)
elif args.train_configuration == "context":
    finetune_model = bart.BartForConditionalGeneration.from_pretrained(args.model_checkpoint)
    extra_context = True
elif args.train_configuration == "supervision":
    finetune_model = bart.BartForConditionalGeneration_DualDecoder.from_pretrained(args.model_checkpoint)
